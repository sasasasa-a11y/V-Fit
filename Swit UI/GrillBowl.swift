                ...
                VStack(spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        HStack(spacing: 16) {
                            ...
                            nutritionBox(title: "Proteins", value: "15", unit: "g", emoji: "🍗")
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        Text("Descriptions")
                            .font(.headline)
                        Text("Grill Bowl is a hearty and delicious bowl of grilled vegetables, protein, and rice — a wholesome combo packed with nutrition and flavor.")
                            .font(.callout)
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack(spacing: 16) {
                                ingredientCard(name: "Grilled Chicken", qty: "1/2 cup", image: "🍗")
                                ingredientCard(name: "Bell Peppers", qty: "1/2 cup", image: "🫑")
                                ingredientCard(name: "Zucchini", qty: "1/4 cup", image: "🥒")
                                ingredientCard(name: "Brown Rice", qty: "1 cup", image: "🍚")
