            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        Text("Side leg raises target the hip abductors, improving balance and strengthening the outer thighs. They’re great for toning and can be done without any equipment.")
                            .font(.subheadline)
                            .foregroundColor(.gray)
                    }
                    .padding(.horizontal)
