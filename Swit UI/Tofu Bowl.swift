...
struct TofuBowlDetailView: View {
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        HStack(spacing: 16) {
                            ...
                            nutritionBox(title: "Proteins", value: "16", unit: "g", emoji: "🍱")
    ...
    func stepDescription(_ step: Int) -> String {
        ...
        case 3: return "Sauté bell peppers and carrots lightly until tender."
